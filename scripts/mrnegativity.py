...
class Script(scripts.Script):
    def title(self):
        return "Mr. Negativity"

    def ui(self, is_img2img):
        enable_m = gr.Checkbox(label="Enable Mr. Negativity", value=True, elem_id=self.elem_id("enable"))
        weight = gr.Slider(label="Mr. Negativity's rage", minimum=0, mmaximum=100, value=50, step=1, elem_id=self.elem_id("weight"))
